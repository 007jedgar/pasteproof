      ...
      >
        ...
        <StatCard
          ...
          value={stats.total_detections > 0 
            ? Math.round((stats.total_anonymizations / stats.total_detections) * 100)
            : 0
          }
          icon="🛡️"
          color="#2196f3"
        ...
        {stats.detections_by_day.length > 0 ? (
          <div style={{ 
            ...
            {stats.detections_by_day.map((item) => {
              const maxCount = Math.max(...stats.detections_by_day.map(d => d.count), 1);
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ borderBottom: "2px solid #ddd", textAlign: "left" }}>
                  <th style={{ padding: "12px 8px", fontSize: "12px", fontWeight: "600", color: "#666" }}>
                    Time
                  </th>
                  <th style={{ padding: "12px 8px", fontSize: "12px", fontWeight: "600", color: "#666" }}>
                    Event
              ...
              <tbody>
                {logs.map((log) => (
                  <tr key={log.id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                    ...
                    <td style={{ padding: "12px 8px", fontSize: "13px" }}>
                      {getEventIcon(log.event_type)} {log.event_type.replace(/_/g, " ")}
                    </td>
                    <td style={{ 
                      padding: "12px 8px", 
                      fontSize: "13px", 
...
function BarItem({ 
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
      ...
      <div style={{ width: "50px", textAlign: "right", fontWeight: "600", fontSize: "14px" }}>
        {value}
      </div>
    </div>
  );
